...
<div class="uv-navbar">
        ...
        <input placeholder="Search" class="uv-search-bar" type="text" name="">
            ...
            <a href="/en/member/tickets">
                ...
                <a href="/en/member/apps#ECommerce">
                    <div class="uv-search-result-row">
                        <div class="uv-brick-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 0 60 60">
                ...
                <a href="/en/member/knowledgebase/announcement">
                    <div class="uv-search-result-row">
                        <div class="uv-brick-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewbox="0 0 60 60">
                ...
                <a href="/en/member/reports/achievements">
                    <div class="uv-search-result-row">
                        <div class="uv-brick-icon">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewbox="0 0 60 60">
                    ...
                    <a href="/en/member/company/theme">
                        ...
                        <div class="uv-search-result-row">
                            ...
                            <p>Email Templates</p>
                                    ...
                                    <a href="/en/member/email-setting">
                        <div class="uv-search-result-row">
                            <div class="uv-brick-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewbox="0 0 60 60">
                    ...
                    <a href="/en/member/company/spam">
                        ...
                        <div class="uv-search-result-row">
                            ...
                            <p>Custom Fields</p>
                                    ...
                                    <a href="/en/member/custom-field/log">
                        <div class="uv-search-result-row">
                            <div class="uv-brick-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewbox="0 0 60 60">
...
<script type="text/javascript">
    $(function () {
        ...
        var NotificationCollection = AppCollection.extend({
            ...
            notices : {},
            url : "/en/member/notifications-xhr",
        ...
        var NotificationItem = Backbone.View.extend({
            tagName : "li",
            template : _.template("<span class='uv-notification-message'><%= message %></span><span class='timeago' data-timestamp='<%= timestamp %>'><%= formatedCreatedAt %></span>"),
            render : function() {
        ...
        var NotificationList = Backbone.View.extend({
            el : $(".uv-notification-list"),
            noticesTemplate : _.template($("#notification_flags_temp").html()),
            events : {
                'click .uv-notifications': 'markRead'
            },
            initialize : function() {
                this.listenTo(notificationCollection, "add", this.renderNotificationPrePend);
                this.render();
            },
            render : function () {
                ...
                if (notificationCollection.length) {
                    this.renderNotices(notificationCollection.notices);

                    _.each(notificationCollection.models, function (item) {
...
<script type="text/javascript">
		...
		<script type="text/javascript">
			$(function () {
				...
				var CreateTicketModel = Backbone.Model.extend({
					...
					urlRoot : "/en/member/ticket/action"
				});
	...
	<style>
        ...
        .uv-kb-header .uv-kb-title {
            line-height: 1.4em;
        }

        .uv-kb-header .uv-kb-description {
            color: #6F6F6F;
            font-style: italic;
            line-height: 1.4em;
        ...
        .knowledgebase-section.uv-kb-tabs ul {
            padding: 0px;
            list-style-type: none;
            border-bottom: solid 1px #D3D3D3;
        }

        .knowledgebase-section.uv-kb-tabs ul li {
            font-size: 15px;
            display: inline-block;
            padding: 15px 20px;
            cursor: pointer;
        ...
        .knowledgebase-section.uv-kb-tabs ul li.uv-tab-active {
            border-bottom-color: #7c70f4;
        }

        .knowledgebase-section.uv-kb-tabs ul li:first-child {
            margin-left: 0px;
        }

        .knowledgebase-section.uv-kb-tabs ul li:hover {
            border-bottom-color: #7c70f4;
        }
        ...
        .uv-kb-category-article-listing {
            width: calc(100% - 20px);
        }

        .uv-kb-category-article-listing > .header {
            display: flex;
            margin-bottom: 20px;
        }

        .uv-kb-category-article-listing > .header h3 {
            line-height: 25px;
            color: #333333;
            font-weight: normal;
            font-size: 16px;
        ...
        .uv-kb-category-article-listing > .header .navigation .uv-pagination {
            margin: unset;
        }

        .uv-kb-folder-category-listing .collection .category-article-details:first-child {
        ...
        .category-article-details .aside {
            width: 180px;
            list-style: none;
            padding: unset;
        ...
        .category-article-details .aside label {
            color: #333333;
            font-size: 13px;
            font-weight: 700;
            line-height: 1.4em;
        ...
        .category-article-details .aside li {
            margin-bottom: 10px;
        }

        .category-article-details .aside li:last-child {
            margin-bottom: unset;
        }

        .category-article-details .aside .detail {
            font-size: 15px;
            margin: unset;
        }

        .category-article-details .content {
            width: 100%;
        }

        .category-article-details .content .header {
            margin-bottom: 20px;
        }

        .category-article-details .content .header h6 {
            color: #333333;
            font-size: 16px;
            line-height: 24px;
            font-weight: 400;
        ...
        .category-article-details .content .header ul {
            font-size: 14px;
            list-style: none;
            margin: unset;
            padding: unset;
        ...
        .category-article-details .content .header ul li {
            display: inline-block;
            vertical-align: middle;
            margin-right: 10px;
        }

        .category-article-details .content .header ul li:last-child {
            margin-right: 0px;
        }

        .category-article-details .content .header .description {
            font-size: 14px;
            margin: unset;
        }

        .category-article-details .content .category-article-tags {
            list-style: none;
            margin: unset;
            padding: unset;
        }

        .category-article-details .content .category-article-tags li {
            display: inline-block;
            vertical-align: top;
        }
	</style>

	<div class="uv-inner-section uv-kb-category" id="knowledgebaseFolders">
        <div class="uv-aside" >
            <div class="uv-aside-head">
                ...
                <div class="uv-aside-back">
                    <span onclick="history.length > 1 ? history.go(-1) : window.location = '/app_dev.php/en/member/dashboard';"> Back</span>
                </div>
            </div>

            <div class="uv-kb-aside-pta">
                <div class="uv-aside-select" id="folder-status-pta">
                    <label class="uv-aside-select-label">Status</label>
                    <div>
                                                    <span class="uv-aside-select-value uv-dropdown-other" data-id="1">Published</span>
                        
                                            </div>
                </div>
                                <div class="uv-aside-select">
                    <label class="uv-aside-select-label">Created At:</label>
                    <p><span class="fa fa-calendar"></span> 11-03-2021 01:38pm</p>
                </div>
                                                    <div class="uv-aside-select">
                        <label class="uv-aside-select-label">Updated At:</label>
                        <p><span class="fa fa-calendar"></span> 11-03-2021 03:07pm</p>
                    </div>
                            </div>

                            <ul class="uv-kb-aside-nav">
                                            <li><a href="/en/folder/702" target="_blank" type="button" class="uv-btn-action">preview</a></li>
                                     </ul>
                    </div>

		<div class="uv-view ">
            <div class="uv-kb-header">
                                    <h1 class="uv-kb-title">ABOUT US</h1>
                
                                    <p class="uv-kb-description">Guru Nanak Dev Engineering College is Guru Nanak Dev Engineering College (GNDEC or GNE Ludhiana) is one of the oldest engineering institutions of the northern region situated at Gill Park, Ludhiana, Punjab, India</p>
                
                                    <div class="knowledgebase-section uv-kb-tabs" id="knowledgebaseTabs" style="">
                        <ul>
                            <li data-section="details" class="uv-tab-active"><i class="fa fa-cog"></i>About</li>
                            <li data-section="articles"><i class="fa fa-newspaper-o"></i>Articles</li>
                            <li data-section="categories"><i class="fa fa-list-alt"></i>Categories</li>
                        </ul>
                    </div>
                            </div>
            <div class="uv-kb-section"><div>
		</div>
	</div>
                    </div>
                </div>
    ...
    <% } %>
            ...
            <!-- Seller Buyer Chat -->
                                            <div class="uv-pop-up-overlay uv-no-error-success-icon" id="contact-uvdesk-modal">
    <div class="uv-pop-up-box uv-pop-up-wide">
        <span class="uv-pop-up-close"></span>
        <h2>Contact Us</h2>
        <form action="/en/member/contact-uvdesk" method="post" id="contact-uvdesk-form">
            <!-- Field -->
            <div class="uv-element-block">
                <label class="uv-field-label">Subject</label>
                <div class="uv-field-block">
                    <input name="subject" class="uv-field" type="text" value="">
                </div>
            </div>
            <!-- //Field -->
            ...
            <!-- Field -->
            <div class="uv-element-block">
                <label class="uv-field-label">Query</label>
                <div class="uv-field-block">
                    <textarea name="query" class="uv-field" type="text"></textarea>
                </div>
            </div>
            <!-- //Field -->
            <div class="uv-element-block">
                <button type="button" class="uv-btn" id="create-uvdesk-form-btn">Send Mail</button>
            </div>
        </form>
    </div>
</div>
...
<script type="text/javascript">
    $(function () {
        var ContactUvdeskModel = Backbone.Model.extend({
            idAttribute : "id",
            defaults : {
                path : "",
            },
        ...
        var ContactUvdeskForm = Backbone.View.extend({
            initialize : function() {
                Backbone.Validation.bind(this);
            },
            events : {
                'click #create-uvdesk-form-btn' : "contactUvdesk",
                'change #type' : "updateCustomFields",
        ...
        var contactUvdeskForm = new ContactUvdeskForm({
            el : $("#contact-uvdesk-form"),
            model : new ContactUvdeskModel()
        });
    });	
</script>

                <div class="uv-pop-up-overlay uv-no-error-success-icon" id="delete-uvdesk-modal">
    <div class="uv-pop-up-box uv-pop-up-wide">
        <span class="uv-pop-up-close"></span>
        <h2>We&#039;re sorry to see you go away :(</h2>

        <form action="/en/member/remove-uvdesk" method="post" id="delete-uvdesk-form">
            <!-- Field -->
            <div class="uv-element-block">
                <label class="uv-field-label">Please tell us the reason why you&#039;re leaving</label>
                <div class="uv-field-block">
                    <textarea name="query" class="uv-field" type="text"></textarea>
                </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        var DeleteUvdeskModel = Backbone.Model.extend({
            idAttribute : "id",
            defaults : {
                path : "",
            },
        ...
        var DeleteUvdeskForm = Backbone.View.extend({
            initialize : function() {
                Backbone.Validation.bind(this);
            },
            events : {
        ...
        var contactUvdeskForm = new DeleteUvdeskForm({
            el : $("#delete-uvdesk-form"),
            model : new DeleteUvdeskModel()
        });
    });
</script>
            ...
            <!-- //Notification Template -->
                                        ...
                                        <script type="text/javascript">
                $(function() {
                                         if('function' == typeof(app.appView.removeDefLoader)) {
                        app.appView.removeDefLoader();
                    } else {
    ...
    <script id="knowledgebase_folder_details_template" type="text/template">
        <form method="post" action="" id="article-form" enctype="multipart/form-data">
            <div class="uv-element-block">
                <label class="uv-field-label">Name</label>

                <div class="uv-field-block">
                    <input type="text" name="title" class="uv-field" value="ABOUT US" />
                </div>
            </div>
            ...
            <div class="uv-element-block">
                ...
                <div class="uv-field-block">
                    <textarea name="description" class="uv-field">Guru Nanak Dev Engineering College is Guru Nanak Dev Engineering College (GNDEC or GNE Ludhiana) is one of the oldest engineering institutions of the northern region situated at Gill Park, Ludhiana, Punjab, India</textarea>
                </div>
            </div>
            <!-- Field -->
            <div class="uv-element-block">
                ...
                <span class="uv-field-info">Choose appropriate status</span>
            </div>
			      <!-- //Field -->
            <div class="uv-element-block uv-no-error-success-icon">
                <label class="uv-field-label">Folder Image</label>
                <!-- Profile image -->
                <div class="uv-image-upload-wrapper" style="padding: 10px 0px 10px 0px; border:none;">
                                    <div class="uv-image-upload-brick uv-on-drop-shadow" style="border-color: transparent;">
                    <input type="file" name="bannerImage" id="uv-upload-profile" accept="image/*" size="3000">
                    ...
                    <img id="dynamic-image-upload" src="https://s3-ap-southeast-1.amazonaws.com/cdn.uvdesk.com/website/8444/download.png">
                  </div>
                </div>
                <span class="uv-field-info">An image is worth a thousands words and makes folder more accessible</span>
            </div>

                            <input class="uv-btn" href="#" value="Update Folder Details" type="submit">
                    </form>
    </script>

    <script id="knowledgebase_folder_section_loading_template" type="text/template">
        <div style="position: relative; margin-top: 180px;">
            <div class="uv-loader" style="position: absolute; top: 50%; left: 50%; margin-top: -15px; margin-left: -30px;">
                <span></span>
                <span></span>
                <span></span>
            </div>
    ...
    <script id="knowledgebase_folder_tagged_categories_template" type="text/template">
        <div class="uv-kb-folder-category-listing">
            <div class="header" style="line-height: 1.4em; margin-bottom: 20px;">
                <h3><div><%- pagination.totalCount %> categories found with folder <span class="uv-kb-category-tag" style="margin-left: 4px;">ABOUT US</span></div></h3>
            </div>
    ...
    <script id="knowledgebase_folder_tagged_articles_template" type="text/template">
        <div class="uv-kb-folder-category-listing">
            <div class="header" style="line-height: 1.4em; margin-bottom: 20px;">
                <h3><div><%- pagination.totalCount %> articles found in folder <span class="uv-kb-category-tag" style="margin-left: 4px;">ABOUT US</span></div></h3>
            </div>
    ...
    <script id="knowledgebase_folder_tagged_articles_collection_template" type="text/template">
        <% _.each(articles, function(article) { %>
            <div class="category-article-details">
                <ul class="aside">
                    <li>
                        <label>Created At:</label>
                        <p class="detail"><%- article.createdAt %></p>
                    </li>
                </ul>
                ...
                <div class="content">
                    <div class="header">
                        <% if (article.isPublished) { %>
                            <h6><%- article.title %> <span class="uv-kb-published-article-tag">Published</span></h6>
                        <% } else { %>
                            <h6><%- article.title %> <span class="uv-kb-draft-article-tag">Draft</span></h6>
                        <% } %>

                        <ul>
                            <li><span class="fa fa-eye"></span> <%- article.totalViews %></li>
                        </ul>
                    </div>

                    <ul class="category-article-tags">
                        <% _.each(article.categories, function(category) { %>
                            <li class="uv-kb-category-tag"><%- category.title %></li>
                        <% }); %>
                    </ul>
                </div>
            </div>
    ...
    <script id="knowledgebase_folder_tagged_categories_collection_template" type="text/template">
        <% _.each(categories, function(category) { %>
            <div class="category-article-details">
                <ul class="aside">
                    <li>
                        <label>Created At:</label>
                        <p class="detail"><%- category.createdAt %></p>
                    </li>
                    <li>
                        <label>Last Updated At:</label>
                        <p class="detail"><%- category.updatedAt %></p>
                    </li>
                </ul>
                ...
                <div class="content">
                    <div class="header">
                        <h6>
                            ...
                            <% if (category.isPublished) { %>
                                <span class="uv-kb-published-article-tag">Published</span>
                            <% } else { %>
                                <span class="uv-kb-draft-article-tag">Draft</span>
                            <% } %>

                            <% if (category.isPrivate) { %>
                                <span class="uv-kb-draft-article-tag">Private</span>
                            <% } %>
                        </h6>
                    ...
                    <ul class="category-article-tags">
                        <% _.each(category.folders, function(folder) { %>
                            <li class="uv-kb-category-tag"><%- folder.title %></li>
                        <% }); %>
                    </ul>
                </div>
            </div>
	...
	<script type="text/javascript">
      $(function () {
          var KnowledgebaseFolderModel = Backbone.Model.extend({
              validation: {
                'title': [{
                  required: true,
                  msg: "Please specify a title for the folder."
                }, {
                  pattern: '^((?![$%<]).)*$',
                  msg: "The folder title must include valid characters only."
                }]
              }
          });

          var KnowledgebaseFolderCategoryModel = Backbone.Model.extend({
              idAttribute: "id"
          });

          var KnowledgebaseFolderArticleModel = Backbone.Model.extend({
              idAttribute: "id"
          });

          var KnowledgebaseFolderArticleCollection = AppCollection.extend({
              model: KnowledgebaseFolderArticleModel,
              url: "/en/member/knowledgebase/folders/702/xhr/articles",
              ...
              load: function(currentPage, sortKey, order) {
                  this.state.order = order;
                  this.state.sortKey = sortKey;
                  this.state.currentPage = currentPage;

                  var node = $('.uv-tab-active');

                  if (node.data('section') != 'articles') {
                      node.removeClass('uv-tab-active');
                      $('li[data-section="articles"]').addClass('uv-tab-active');
                  }

                  if ($('.uv-kb-folder-article-listing').length == 0) {
                      $('.uv-kb-section').html(this.parent.folder_section_loading_template());
                  }
                  ...
                  this.fetch({
                      ...
                      success: (model, response) => {
                          if ($('.uv-kb-folder-article-listing').length == 0) {
                              $('.uv-kb-section').html(this.parent.folder_tagged_articles_template({
                          ...
                          if (response.length == 0 && app.pager.paginationData.current != "0")
                              router.navigate(url.replace('replacePage', app.pager.paginationData.last), { trigger: true });
                          else {
                              app.pager.render();
                          }

                          $('.uv-kb-section .collection').html(this.parent.folder_tagged_articles_collection_template({
          ...
          var KnowledgebaseFolderCategoryCollection = AppCollection.extend({
              model: KnowledgebaseFolderCategoryModel,
              url: "/en/member/knowledgebase/folders/702/xhr/categories",
              initialize: function(params) {
                  this.parent = params.parent;
              },
              parseRecords: function (resp, options) {
              ...
              load: function(currentPage, sortKey, order) {
                  ...
                  if (node.data('section') != 'categories') {
                      node.removeClass('uv-tab-active');
                      $('li[data-section="categories"]').addClass('uv-tab-active');
                  }

                  if ($('.uv-kb-folder-category-listing').length == 0) {
                      $('.uv-kb-section').html(this.parent.folder_section_loading_template());
                  }
                  ...
                  this.fetch({
                      ...
                      success: (model, response) => {
                          if ($('.uv-kb-folder-category-listing').length == 0) {
                              $('.uv-kb-section').html(this.parent.folder_tagged_categories_template({
                                  pagination: response.pagination
                              }));
                          }
                          ...
                          $('.uv-kb-section .collection').html(this.parent.folder_tagged_categories_collection_template({
          ...
          var Knowledgebase = Backbone.View.extend({
              folder_details_template: _.template($("#knowledgebase_folder_details_template").html()),
              folder_section_loading_template: _.template($("#knowledgebase_folder_section_loading_template").html()),
              folder_tagged_categories_template: _.template($("#knowledgebase_folder_tagged_categories_template").html()),
              folder_tagged_articles_template: _.template($("#knowledgebase_folder_tagged_articles_template").html()),
              folder_tagged_categories_collection_template: _.template($("#knowledgebase_folder_tagged_categories_collection_template").html()),
              folder_tagged_articles_collection_template: _.template($("#knowledgebase_folder_tagged_articles_collection_template").html()),
              loader_template: _.template($("#loader-tmp").html()),

              events : {
                  'click .uv-kb-tabs li': 'navigateTab',
                  'blur input, textarea': 'formChanged',
                  'submit #article-form': 'updateCategoryDetails',
                  'click #folder-status-pta .uv-dropdown-list li': 'updatePublishingStatus',
              },

              initialize : function(params) {
                  this.articles = new KnowledgebaseFolderArticleCollection({
                      parent: this
                  });

                  this.categories = new KnowledgebaseFolderCategoryCollection({
                      parent: this
                  });
              ...
              updatePublishingStatus: function (e) {
                  var target = $(e.target);
                  var isPublished = target.data('index');

                  var url = "/en/member/knowledgebase/folders/702/xhr/status";

                  $.post(url, {
                      isPublished: isPublished
                  }, function(response) {
                      $('#folder-status-pta .uv-dropdown-list li').removeAttr('selected');
                      target.attr('selected', 'selected');

                      if (response.content.isPublished == true) {
                          $('#folder-status-pta .uv-aside-select-value').data('id', 1);
                          $('#folder-status-pta .uv-aside-select-value').html('Published');
                      } else {
                          $('#folder-status-pta .uv-aside-select-value').data('id', 0);
                          $('#folder-status-pta .uv-aside-select-value').html('Draft');
                      }
                  });
              },
              updateCategoryDetails: function(e) {
                  this.model.set($('#article-form').serializeObject());

                  if (false == this.model.isValid(true)) {
                      e.preventDefault();
                  }
              },
              navigateTab: function(e) {
                  var target = $(e.target);
                  var current = $('.uv-tab-active');

                  if (target[0].tagName == 'I') {
                      target = $(target[0]).parent();
                  }

                  var targetSection = target.data('section');
                  var currentSection = current.data('section');

                  if (currentSection != targetSection) {
                      var path = (targetSection == 'details') ? '#' : '#' + target.data('section');
                      router.navigate(path, { trigger: true });
                  }
              },
              renderFolderDetails: function() {
                  var node = $('.uv-tab-active');

                  if (node.data('section') != 'details') {
                      node.removeClass('uv-tab-active');
                      $('li[data-section="details"]').addClass('uv-tab-active');
                  }

                  $('.uv-kb-section').html(this.folder_details_template());
              }
          });

          var Router = Backbone.Router.extend({
              routes: {
                  '': 'knowledgebaseFolderDetails',
                  'articles(/page/:number)(/sort/:sortField)(/direction/:order)': 'knowledgebaseFolderTaggedArticles',
                  'categories(/page/:number)(/sort/:sortField)(/direction/:order)': 'knowledgebaseFolderTaggedCategories',
              },
              initialize: function(params) {
                  this.knowledgebase = params.knowledgebase;
              },
              knowledgebaseFolderDetails: function() {
                  this.knowledgebase.renderFolderDetails();
              },
              knowledgebaseFolderTaggedArticles: function(number, sortField, order) {
                  this.knowledgebase.articles.load(number, sortField, order);
              },
              knowledgebaseFolderTaggedCategories: function(number, sortField, order) {
                  this.knowledgebase.categories.load(number, sortField, order);
              },
          });

          var knowledgebase = new Knowledgebase({
              el: $("#knowledgebaseFolders"),
              model: new KnowledgebaseFolderModel()
          });
