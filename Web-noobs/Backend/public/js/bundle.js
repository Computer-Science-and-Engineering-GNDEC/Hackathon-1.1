...
},{}],"createQuery.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createNewQuery = void 0;
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(title, query, branch, tags) {
    var res;
  ...
  return function createNewQuery(_x, _x2, _x3, _x4) {
...
},{"axios":"../../../../../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteQuery.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteThisQuery = void 0;
...
function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.statusCode === 200) {
              location.assign("/");
              (0, _alerts.showAlert)("success", "Query deleted succefully!");
            }
  ...
  return function deleteThisQuery(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteThisQuery = deleteThisQuery;
...
var _createQuery = require("./createQuery");
...
var createQueryForm = document.querySelector(".form-create");
var deleteQueryForm = document.querySelector(".form-delete");
var deleteUserForm = document.querySelector(".form-deleteUser"); //Values
...
if (createQueryForm) createQueryForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var title = document.getElementById("Eventname").value;
  var query = document.getElementById("Eventduration").value;
  var branch = document.getElementById("Eventteam").value;
  var tags = document.getElementById("Eventprice").value;
  (0, _createQuery.createNewQuery)(title, query, branch, tags);
});
if (deleteQueryForm) deleteQueryForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var id = document.getElementById("Eventid").value;
  (0, _deleteQuery.deleteThisQuery)(id);
});
