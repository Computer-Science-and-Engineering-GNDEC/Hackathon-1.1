...
},{}],"createEvent.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, duration, team, price, StartDates, description, link) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Event Created Succesfully!');
  ...
  return function createNewEvent(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You will recieve a verification link to your email in under 6 minutes');
              window.setTimeout(function () {
...
},{"axios":"../../../../../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteEvent.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteThisEvent = void 0;
...
function () {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.statusCode === 200) {
              location.assign('/');
              (0, _alerts.showAlert)('success', 'Event deleted succefully!');
            }
  ...
  return function deleteThisEvent(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteThisEvent = deleteThisEvent;
...
function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.statusCode === 200) {
              location.assign('/');
              (0, _alerts.showAlert)('success', 'User deleted succefully!');
            }
  ...
  return function deleteThisUser(_x) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Reset Token Sent to Email!');
              window.setTimeout(function () {
...
},{"axios":"../../../../../../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/base64-js/index.js":[function(require,module,exports) {
'use strict'
...
},{"buffer":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/buffer/index.js"}],"../../node_modules/basic-auth/index.js":[function(require,module,exports) {
...
},{"./debug":"../../node_modules/debug/src/debug.js","process":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/morgan/node_modules/depd/lib/browser/index.js":[function(require,module,exports) {
/*!
 * depd
...
},{"ee-first":"../../node_modules/ee-first/index.js","process":"../../../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/node_modules/process/browser.js"}],"../../node_modules/on-headers/index.js":[function(require,module,exports) {
/*!
 * on-headers
 * Copyright(c) 2014 Douglas Christopher Wilson
 * MIT Licensed
...
function () {
  var _ref = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(password, passwordConfirm, tok) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "/api/v1/users/resetPassword/".concat(tok),
              data: {
                password: password,
                passwordConfirm: passwordConfirm
              }
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Your password is Set!');
              window.setTimeout(function () {
  ...
  return function ResetMyPassword(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.ResetMyPassword = ResetMyPassword;
},{"axios":"../../../../../../../node_modules/axios/index.js","morgan":"../../node_modules/morgan/index.js","./alerts":"alerts.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var createEventForm = document.querySelector(".form-create");
var deleteEventForm = document.querySelector(".form-delete");
var deleteUserForm = document.querySelector(".form-deleteUser");
var forgotPasswordForm = document.querySelector(".form--forgot");
var resetPasswordForm = document.querySelector(".form--reset"); //Values
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector(".btn--save-password-account").textContent = "Updating...";
          ...
          case 7:
            document.querySelector(".btn--save-password-account").textContent = "Save Password";
...
if (createEventForm) createEventForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var name = document.getElementById("Eventname").value;
  var duration = document.getElementById("Eventduration").value;
  var team = document.getElementById("Eventteam").value;
  var price = document.getElementById("Eventprice").value;
  var StartDates = document.getElementById("EventStartDates").value;
  var description = document.getElementById("EventDescription").value;
  var link = document.getElementById("link").value;
  (0, _createEvent.createNewEvent)(name, duration, team, price, StartDates, description, link);
});
if (deleteEventForm) deleteEventForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var id = document.getElementById("Eventid").value;
  (0, _deleteEvent.deleteThisEvent)(id);
});
if (deleteUserForm) deleteUserForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var id = document.getElementById("Userid").value;
  (0, _deleteUser.deleteThisUser)(id);
});
if (forgotPasswordForm) forgotPasswordForm.addEventListener("submit", function (e) {
  e.preventDefault();
  var email = document.getElementById("email").value;
  (0, _forgotPassword.forgotMyPassword)(email);
});
